...
#data_files = "/root/AI-WSL/data/alpaca_map_fn_StandardDataSet"
...
evaluation_inputs = ["只剩一个心脏了还能活吗？", "樟脑丸是我吃过最难吃的硬糖有奇怪的味道怎么还有人买"
                     ,"为什么没人说ABCD型的成语？🤔","为什麽我老婆内裤拔下来没有马赛克？"]
...
alpaca_en = dict(
    ...
    #dataset=dict(type=load_dataset, path=data_files),
